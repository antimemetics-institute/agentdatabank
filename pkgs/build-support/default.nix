...
in
{
  ...
  # declarations never reach above their own directory with relative paths — a
  # forked directory must evaluate anywhere, and this file resolves inside
  # whichever adb is being evaluated (checkout, tarball, or a fork's pin)
